<%@ Page Title="" Language="C#" MasterPageFile="~/Volunteer/volunteerMaster.master" AutoEventWireup="true" CodeFile="volunteer_myprofile.aspx.cs" Inherits="Volunteer_voluntter_myprofile" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h3 class="heading text-uppercase text-center">
    My profile</h3>
<table class="style1">
    <tr>
        <td class="style11">
    ...
    <tr>
        ...
        <td class="style8" align="center" rowspan="3">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <tr>
        ...
        <td class="style8" align="center">
            <asp:FileUpload ID="fluphoto" class="form-control" Width="250px" runat="server" 
                    Height="40px" />
        </td>
        <td class="style9" align="center">
    ...
    <tr>
        ...
        <td class="style8" align="center">
            <asp:Button ID="Button1" class="btn btn-primary" runat="server" runat="server" Text="Upload" 
