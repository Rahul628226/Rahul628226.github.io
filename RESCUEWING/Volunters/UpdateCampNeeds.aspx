<%@ Page Title="" Language="C#" MasterPageFile="~/Volunters/Volontiers.master" AutoEventWireup="true" CodeFile="UpdateCampNeeds.aspx.cs" Inherits="Volunters_UpdateCampNeeds" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h3 class="heading text-uppercase text-center">Updates Camp Needs</h3>
                            ...
                            <tr>
                                <td>
                                    <asp:Button ID="Button2" runat="server" CommandArgument='<%# Eval("id") %>' 
                                        CommandName="remove" Text="Delete" />
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
