...
public partial class Volunters_Volunteers_Myprofile : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            string str = "select * from voluntiers_registration where id='" + Session["id"].ToString() + "'";
    ...
    {
        string str = "Update voluntiers_registration set FirstName='" + txtfirstname.Text + "',LastName='" + txtlastname.Text + "',district='" + ddlselectdistrict.SelectedItem.Text + "',address='" + txtaddress.Text + "',pincode='" + txtpincode.Text + "',bloodtype='" + ddlbloodtype.SelectedItem.Text + "',gender='" + rdogender.SelectedItem.Text + "',dateofbirth='" + txtdateofbirth.Text + "',Email='" + txtemail.Text + "',pnonenumber='" + txtp.Text + "',photo='" + imgphoto.ImageUrl + "'where id='" + Session["id"].ToString() + "'";
    ...
    {
        string str = "delete from voluntiers_registration where id='" + Session["id"].ToString() + "'";
        int r = dm.For_Execute(str);
        if (r > 0)
        {
        ...
        protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string str = "Update voluntiers_registration set photo='" + imgphoto.ImageUrl + "'where id='" + Session["id"].ToString() + "'";
        int r = dm.For_Execute(str);
         if (fluphoto.HasFile)
        {
