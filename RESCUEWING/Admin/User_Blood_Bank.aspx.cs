...
public partial class Admin_User_Blood_Bank : System.Web.UI.Page
{
    ...
    public void Bind()
    {
        DataSet ds = dm.For_Adapter("select id,FirstName,LastName,BloodGroup,PhoneNumber,LastDonateDate from User_Blood_Bank_DB");
    ...
    {
        Panel1.Visible = true;
        string str = "select *from User_Blood_Bank_DB where id='" + GridView1.SelectedRow.Cells[0].Text + "'";
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            lblpincode.Text = ds.Tables[0].Rows[0][10].ToString();
        }
    }
}